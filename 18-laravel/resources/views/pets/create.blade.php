    ...
    <main class="bg-blue-950 pt-20 bg-cover w-full min-h-[100dvh] flex flex-col justify-center items-center">
        <div class="bg-[#0006] md:w-10/12 w-full text-white p-10 rounded-lg flex flex-col justify-center items-center">
            ...
            <form action="{{ url('pets') }}" class="my-4 flex flex-col gap-2" method="post" enctype="multipart/form-data" >
                ...
                <input type="file" name="image" id="photo" class="hidden" accept="image/*" />
                ...
                <div>
                    ...
                    <select name="kind" class="w-full select bg-blue-950 border-white">
                ...
                <div>
                    <label class="mt-4" for="">Age (years old):</label>
        ...
        $(document).ready(function() {
            ...
            @if (count($errors->all()) > 0)
                ...
                @foreach ($errors->all() as $msg)
                    @php $content .= '<li class="badge badge-blue text-xs w-full">'.$msg.'</li>' @endphp
                @endforeach
